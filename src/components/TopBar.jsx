        ...
        <div className=' h-min w-full shadow-[0_2px_4px_0_rgba(0,0,0,0.15)] bg-white flex justify-between'>
            ...
            <div className='flex'>
                ...
                <div className="relative text-gray-600 w-min md:ml-8 my-4 ">
                    <input type="search" name="serch" placeholder="Search bookings" className="bg-white w-[180px] md:w-[331px] h-10 px-4 pr-10 rounded-full text-sm focus:outline-none shadow-[0_2px_4px_0_rgba(0,0,0,0.25)]" />
                ...
                <button className="hidden  bg-gradient-to-b from-[#FB8085] to-[#FF5757] rounded-full px-8 my-4 mx-5 shadow-md text-md text-white sm:flex items-center">
            ...
            <div className='flex rounded-full shadow-[0_2px_4px_0_rgba(0,0,0,0.25)] items-center justify-center sm:mr-4 my-4'>
                <div className="hidden relative w-8 h-8 rounded-full md:block">
                    <img className="object-cover w-full h-full rounded-full" src="https://th.bing.com/th/id/OIP.8E92ZiqboR-GqhX-TRX93gHaHb?pid=ImgDet&rs=1" alt="" loading="lazy" />
                    <div className="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                </div>
                <div className='px-2 text-xs lg:text-base font-normal'>
                    Hello Lokesh! 👋
                </div>
            </div>
        </div>
