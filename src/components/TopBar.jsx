        ...
        <div className=' h-min w-full shadow-[0_2px_4px_0_rgba(0,0,0,0.15)] bg-white flex justify-between'>
            ...
            <div className='flex'>
                ...
                <div className="relative text-gray-600 w-min md:ml-8 my-4 ">
                    <input type="search" name="serch" placeholder="Search bookings" className="bg-white md:w-[331px] h-10 px-4 pr-10 rounded-full text-sm focus:outline-none shadow-[0_2px_4px_0_rgba(0,0,0,0.25)]" />
